...
def edemData(output_table):
    ...
    with beam.Pipeline(options=options) as p:
        ...
        data = (
            ...
            p | "Read messages from PubSub" >>  beam.io.ReadFromPubSub(subscription=f"projects/serverless-franzi/subscriptions/{output_table}-sub", with_attributes=True)
        ...
        (data | "Write to BigQuery" >>  beam.io.WriteToBigQuery(
            table = f"serverless-franzi:edemDataset.{output_table}",
            schema = schema,
        ...
        (data 
            ...
            | "WriteToPubSub" >>  beam.io.WriteToPubSub(topic="projects/serverless-franzi/topics/iotToCloudFunctions", with_attributes=False)
        )
